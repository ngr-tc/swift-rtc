...
public struct Base64 {
    ...
    @inlinable
    public static func encode<Buffer: Collection>(bytes: Buffer) -> String
    where Buffer.Element == UInt8 {
        ...
        let alphabet = Base64.encodeTable
        ...
        return String(customUnsafeUninitializedCapacity: base64StringLength) { backingStorage in
            ...
            while let firstByte = input.next() {
                ...
                backingStorage[offset + 1] = Base64.encode(
                    alphabet: alphabet, firstByte: firstByte, secondByte: secondByte)
                backingStorage[offset + 2] = Base64.encode(
                    alphabet: alphabet, secondByte: secondByte, thirdByte: thirdByte)
